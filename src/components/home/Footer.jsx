                    ...
                    <div className="centerFaller">
                        ...
                        <div>
                            <div className="address_1">
                                <h5>SUPPORT</h5>
                                <p>Available 24/7 for all your investment needs</p>
                            ...
                            <div className="address_1">
                                <h5>WHATSAPP</h5>
                                <p>
                                    <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" style={{ color: "inherit" }}>
                                        <img src="/whatsapp.svg" alt="whatsapp" style={{ width: "16px", marginRight: "6px", verticalAlign: "middle" }} />
