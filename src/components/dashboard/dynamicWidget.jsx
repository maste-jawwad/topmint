                ...
                widgetState.type === "invest" && (
                    <div className="avatarSection investwidgetSection">
                        ...
                        <div className="investMinmax">
                            {
                                investData?.plan === "Silver" ? "Min. Capital: USD 250 | Max. Capital: USD 900" : investData?.plan === "Gold" ? "Min. Capital: USD 1000 | Max. Capital: USD 9000" : "Min. Capital: USD 10,000 | Max. Capital: USD 100,000"
                            }
